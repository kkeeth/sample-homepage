    ...
    <>
      <div className="flex-row md:flex md:flex-col justify-center items-center p-4">
        <div className="w-full md:flex md:justify-between">
          ...
          <div className="md:w-1/2 p-4">
            <h2 className="text-5xl font-semibold text-[#747bff] mb-8 underline">
              ポッドキャスト
            </h2>
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="relative h-60 w-full rounded-lg bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 sm:h-64">
                <a
                ...
                >
                  <img
                    ...
                    className="h-full w-full object-cover object-center rounded-lg border-2"
                  />
        ...
        <div className="w-full md:flex md:justify-between">
          <div className="md:w-1/2 py-12 px-24">
            <h2 className="text-5xl font-semibold text-[#747bff] mb-8 underline">
              npm
            </h2>
          ...
          <div className="md:w-1/2 p-4">
            ...
            <div>
              <a
                ...
                className="flex"
              >
                <span className="text-xl">Riot.jsで簡単Webアプリ開発</span>
